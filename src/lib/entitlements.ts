...
export const RATE_TABLE: Record<string, FeatureRateInfo> = {
  ...
  humanizer_rewrite: {
    ...
    billingUnit: 'words_1000',
    minPlan: 'free',
    description: '10 credits per started 1,000 input words',
  },
  ai_summarizer: {
  ...
  plagiarism_check: {
    ...
    billingUnit: 'words_1000',
    minPlan: 'free',
    description: '10 credits per started 1,000 words',
  },
  seo_assistant: {
    ...
    billingUnit: 'words_1000',
    minPlan: 'pro',
    description: '30 credits per comprehensive SEO assistant report (Pro plan required)',
  },
  image_detect_standard: {
    ...
    billingUnit: 'image',
    minPlan: 'guest',
    description: '5 credits per image analyzed',
  },
  image_detect_advanced: {
    ...
    billingUnit: 'image',
    minPlan: 'pro',
    description: '10 credits per image for forensic deepfake analysis',
  },
  deepfake_detector: {
    featureSlug: 'deepfake_detector',
    name: 'Deepfake Detector',
    trialEligible: false,
    baseCreditCost: 10,
    billingUnit: 'image',
    minPlan: 'pro',
    description: '10 credits per forensic deepfake detection scan',
  },
  video_detect_balanced: {
    ...
    minPlan: 'guest',
    description: '15 credits per started 30 seconds',
  },
  ...
  video_detect_forensic: {
    ...
    billingUnit: 'video_30s',
    minPlan: 'pro_plus',
    description: '15 credits per started 30 seconds (Pro Plus only)',
  },
  voice_analysis: {
    ...
    minPlan: 'guest',
    description: '5 credits per started audio minute',
  },
  citation_verify: {
    ...
    minPlan: 'pro',
    description: '5 credits per 5 references checked',
  },
  hallucination_check: {
    ...
    billingUnit: 'words_1000',
    minPlan: 'pro',
    description: '5 credits per started 1,000 words',
  },
...
for (const [alias, canonical] of Object.entries({
  ...
  ai_voice_detector: 'voice_analysis',
