...
export default function ConversionOptimizationPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageMeta
        title="Conversion Rate Optimization Agency | AIDetector.cx"
        description="Turn more of your existing traffic into qualified leads and paying customers with data-driven CRO and funnel experimentation."
        canonicalUrl="https://aidetector.cx/services/conversion-optimization"
        ogTitle="Conversion Rate Optimization Agency | AIDetector.cx"
        ogDescription="We optimize your entire funnel—from landing pages to checkout—to maximize your conversion rates and revenue."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Let's find the bottlenecks in your funnel. Request a free conversion audit and we'll show you exactly how to lower your CAC and lift conversion rates. Pair this with our <Link to="/seo-assistant" className="text-primary hover:underline">SEO Assistant</Link> or <Link to="/services/ai-consulting" className="text-primary hover:underline">AI Consulting</Link> for maximum impact.
              </p>
