          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Schedule a confidential consultation. We'll discuss your operational bottlenecks and explore how custom AI can solve them. Interested in optimization? Check out our <Link to="/services/conversion-optimization" className="text-primary hover:underline">Conversion Optimization</Link> and <Link to="/seo-assistant" className="text-primary hover:underline">SEO Assistant</Link> solutions.
              </p>
