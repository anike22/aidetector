...
// usageStats retained for future dashboard enhancements
import { 
    ...
    <div className="flex flex-col gap-8 pb-8">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4">
          <NextBestActionCard embedded />
          <ActivationChecklistWidget embedded />
        </div>
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <LifecycleStageBadge stage={lifecycleProfile?.lifecycle_stage} />
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Activation</p>
              <Progress value={lifecycleProfile?.activation_score || 0} className="mt-1 h-2" />
              <p className="mt-0.5 text-sm font-medium">{lifecycleProfile?.activation_score || 0}/100</p>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Health</p>
              <Progress value={lifecycleProfile?.health_score || 0} className="mt-1 h-2" />
              <p className="mt-0.5 text-sm font-medium">{lifecycleProfile?.health_score || 0}/100</p>
            </div>
            <Button variant="outline" className="w-full" asChild>
              <Link to="/dashboard/progress">View Full Progress</Link>
            </Button>
          </CardContent>
        </Card>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="hover:border-primary/50 transition-colors cursor-pointer shadow-premium border-border/50 rounded-2xl bg-card" onClick={() => navigate('/api/dashboard')}>
            <CardContent className="p-5 flex items-start gap-4">
              <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center shrink-0">
                <Code className="w-5 h-5 text-emerald-600" />
              </div>
              <div>
                <h3 className="font-semibold text-navy">API Dashboard</h3>
                <p className="text-xs text-muted-foreground mt-1">API keys and usage</p>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* ENTERPRISE & PRO SOLUTIONS */}
          <Card className="bg-navy text-white overflow-hidden relative">
            <div className="absolute top-0 right-0 p-4 opacity-10">
              <Zap className="w-24 h-24" />
            </div>
            <CardContent className="p-6 relative z-10">
              <Badge className="bg-card/20 hover:bg-card/30 text-white mb-3 border-none">Enterprise API</Badge>
              <h3 className="font-bold text-lg mb-2">Automate High-Volume Detection</h3>
              <p className="text-white/80 text-sm mb-4 text-pretty">
                Integrate AIDetector.cx directly into your publishing CMS, LMS, or automated workflow with our low-latency REST API.
              </p>
              <Button className="w-full bg-card text-navy hover:bg-card/90" onClick={() => navigate('/api')}>
          ...
          <Card className="shadow-premium border-border/50 rounded-2xl bg-card">
            <CardContent className="p-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Button variant="ghost" className="justify-start h-8 px-2 text-sm text-muted-foreground hover:text-navy" onClick={() => navigate('/contact')}>
