...
import {
  ...
  ImageIcon, Video, ScanFace, Trash2, Eye, Download, Package, Plus, Edit2, EyeOff, Target, Briefcase, Search, Link2, Shield, ShieldCheck, Users
} from 'lucide-react';
...
const sidebarItems = [
  ...
  { label: 'Author Profile & Attestation', href: '/authorship/profile', icon: Shield },
  { label: 'Verified Authorship Dashboard', href: '/authorship/dashboard', icon: Shield },
  ...
  { label: 'Team Credits & Seats', href: '#team-credits', icon: Users },
...
type DashboardSection = 'overview' | 'reports' | 'documents' | 'prospecting' | 'crm' | 'tools' | 'activity' | 'content-studio' | 'seo-assistant' | 'bookmarks' | 'purchases' | 'team-credits' | 'subscription' | 'settings' | 'my-products' | 'api-keys';
      ...
      <div className="flex min-h-[calc(100vh-4rem)] bg-secondary/30">
        ...
        <div className="flex-1 min-w-0 overflow-x-hidden flex flex-col">
          ...
          <div className="flex-1 p-4 md:p-6 overflow-y-auto overflow-x-hidden min-h-0">
            {activeSection === 'overview' && <RecommendationStrip />}
            ...
            {/* ─── TEAM CREDITS & SEATS ─── */}
            {activeSection === 'team-credits' && (
              <div className="space-y-6">
                <div className="mb-2">
                  <h1 className="text-xl font-bold text-navy mb-1">Team Credit Allocation & Usage</h1>
                  <p className="text-sm text-muted-foreground">Manage credit distribution across team member seats and track usage.</p>
                </div>
                <TeamCreditManagement />
              </div>
            )}
            ...
            {activeSection === 'subscription' && (
              <div className="space-y-6">
                <div className="mb-2">
                  <h1 className="text-xl font-bold text-navy mb-1">Subscription & Credits</h1>
                  <p className="text-sm text-muted-foreground">Manage your plan, live credit ledger, and team allocations.</p>
                </div>
                <LiveUsagePanel />
                <TeamCreditManagement />
              </div>
