...
import {
  ...
  MessageSquare, BookOpen, MessageCircle, Film, Cpu, ShieldCheck
} from 'lucide-react';
import { VideoDetectorAdminTab } from '@/components/detector/VideoDetectorAdminTab';
import AuthorshipAdminTab from '@/components/verified-authorship/AuthorshipAdminTab';
    ...
    <MainLayout>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" onClick={() => navigate('/admin/detector-benchmark')} className="gap-2">
              <BarChart3 className="w-3.5 h-3.5" /> Engine Benchmark
            </Button>
            <Button variant="outline" size="sm" onClick={() => navigate('/admin/detector-feedback')} className="gap-2">
              <MessageCircle className="w-3.5 h-3.5" /> Feedback Quality
            </Button>
          ...
          <Tabs defaultValue="stats" className="space-y-6">
            <div className="space-y-2">
              ...
              <TabsList className="flex-wrap h-auto gap-1">
                ...
                <TabsTrigger value="video_forensics" className="gap-2"><Film className="w-3.5 h-3.5" />Video Governance</TabsTrigger>
                <TabsTrigger value="authorship_admin" className="gap-2"><ShieldCheck className="w-3.5 h-3.5" />Verified Authorship</TabsTrigger>
              </TabsList>
            ...
            {/* ── Video Forensics & Governance Tab ─────────────────────── */}
            <TabsContent value="video_forensics">
              <VideoDetectorAdminTab />
            </TabsContent>

            <TabsContent value="authorship_admin">
              <AuthorshipAdminTab />
            </TabsContent>
