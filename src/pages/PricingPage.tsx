...
const RATE_ITEMS = [
  { feature: 'AI Checker for Bloggers (Standard Workflow)', rate: '30 credits per comprehensive report', unit: 'Per workflow', trial: true },
  ...
  { feature: 'Humanizer Rewrite Engine', rate: '10 credits per 1,000 input words', unit: 'Per 1k words', trial: true },
  { feature: 'Generate Article / With AI', rate: '5 credits per article generation', unit: 'Per article', trial: true },
  { feature: 'Plagiarism Checker Deep Search', rate: '10 credits per 1,000 words', unit: 'Per 1k words', trial: true },
  { feature: 'SEO Assistant Full Report', rate: '30 credits per comprehensive audit', unit: 'Per report', trial: false },
  { feature: 'Standard Image Detection', rate: '5 credits per image', unit: 'Per image', trial: true },
  { feature: 'Deepfake Detector / Forensic Image Analysis', rate: '10 credits per scan', unit: 'Per scan', trial: false },
  { feature: 'Video Detection (AI Video / Forensic)', rate: '15 credits per started 30 seconds', unit: 'Per 30s', trial: true },
  { feature: 'Voice & Speech Audio Analysis', rate: '5 credits per audio minute', unit: 'Per min', trial: true },
  { feature: 'Citation Verification', rate: '5 credits per 5 references', unit: 'Per 5 refs', trial: false },
  { feature: 'Hallucination Checker', rate: '5 credits per 1,000 words', unit: 'Per 1k words', trial: false },
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'We use a central, transparent rate table: standard AI text detection costs 1 credit per started 1,000 words per engine; Humanizer costs 10 credits/1,000 words; Plagiarism costs 10 credits/1,000 words; AI image detection costs 5 credits; voice/audio costs 5 credits; deepfake detector costs 10 credits; video costs 15 credits per 30s; citation/hallucination checks cost 5 credits; AI Checker for Bloggers / SEO Assistant cost 30 credits. The exact cost is always displayed beside the action button before you execute.',
  },
  {
