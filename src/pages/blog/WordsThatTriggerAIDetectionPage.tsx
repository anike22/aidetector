          ...
          <section id="what-detectors-analyze" className="scroll-mt-28 py-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="border-border">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Burstiness tracks variation in sentence length and complexity. Human writing is erratic; AI writing is more uniform. To check your own draft, the <Link to="/word-counter" className="text-primary hover:underline">free word counter</Link> highlights sentences that exceed a length you choose.
                </CardContent>
              </Card>
              <Card className="border-border">
                <CardHeader className="pb-3">
