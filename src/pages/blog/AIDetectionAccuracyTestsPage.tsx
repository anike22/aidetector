...
export default function AIDetectionAccuracyTestsPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "AI Detection Accuracy Tests", "item": "https://aidetector.cx/research/ai-detection-accuracy-tests" }
    ]
  };
  ...
  return (
    <MainLayout>
      <PageMeta
        ...
        canonicalUrl="https://www.aidetector.cx/research/ai-detection-accuracy-tests"
      ...
      <article className="max-w-5xl mx-auto px-4 py-12 md:py-20">
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/comparisons/turnitin-vs-aidetector-cx" className="px-4 py-2 bg-card border border-border rounded-full text-sm hover:border-primary hover:text-primary transition-colors">Turnitin vs AIDetector.cx</Link>
