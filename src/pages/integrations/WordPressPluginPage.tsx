...
export default function WordPressPluginPage() {
  ...
  const handleDownload = async () => {
    ...
    setTimeout(() => {
      ...
      trackToolUsage('plugin', { action: 'plugin_downloaded', page: '/wordpress-plugin' });
      trackLifecycleEvent('plugin_installed', { page: '/wordpress-plugin' });
      trackLifecycleEvent('plugin_use', { page: '/wordpress-plugin' });
    }, 800);
  };
  ...
  return (
    <MainLayout>
      <PageLeadCapture
        ...
        timeSeconds={60}
        showSticky={true}
        stickyLabel="Connect Your WordPress Sites"
        stickySubLabel="Free account — manage all sites in one place"
      />
      <PageMeta
