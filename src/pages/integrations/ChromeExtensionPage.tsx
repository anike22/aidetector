...
export default function ChromeExtensionPage() {
  ...
  const handleInstall = () => {
    ...
    setTimeout(() => {
      ...
      trackToolUsage('extension', { action: 'extension_installed', page: '/chrome-extension' });
      trackLifecycleEvent('extension_installed', { page: '/chrome-extension' });
      trackLifecycleEvent('extension_use', { page: '/chrome-extension' });
    }, 1000);
  };
  ...
  return (
    <MainLayout>
      <PageLeadCapture
        ...
        timeSeconds={60}
        showSticky={true}
        stickyLabel="Sync Your Browser Activity"
        stickySubLabel="Free account — works across all your devices"
      />
      <PageMeta
