...
describe('AI Assistant & Floating Widget Accuracy Tests', () => {
  ...
  describe('3. Knowledge Base Query Answers & Accuracy', () => {
    ...
    it('accurately explains trial checks, credit consumption rates, and pricing', () => {
      ...
      expect(res.text).toContain('Standard AI Detector: 1 credit');
      expect(res.text).toContain('Humanizer: 10 credits');
      expect(res.text).toContain('SEO Assistant / AI Checker for Bloggers: 30 credits');
