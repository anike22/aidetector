...
import { navStructure, directLinks, mobileAuthGroups, NavGroup, findParentGroupIdByPath, matchRoute } from '@/components/layouts/navData';
import type { Organization } from '@/types/team';
import {
  Menu, X, LogOut, Search, FileSearch, FileEdit, DollarSign,
  Key, Zap, Check, ChevronDown, Code,
} from 'lucide-react';
