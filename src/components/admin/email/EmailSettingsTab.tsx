    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="pt-4 border-t border-border">
          <CardTitle className="text-lg mb-4">Platform Branding</CardTitle>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label>Sender Display Name</Label>
              <Input 
                placeholder="AIDetector.cx" 
                value={settings.sender_display_name || ''} 
                onChange={e => setSettings({...settings, sender_display_name: e.target.value})}
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input 
                type="email" 
                placeholder="business@aidetector.cx" 
            ...
            <div className="space-y-2">
              ...
              <Input 
                placeholder="https://aidetector.cx/images/logo/logo-icon.svg" 
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input 
                placeholder="123 Innovation Drive, Suite 100" 
