...
export default function UpgradeModal({
  ...
  const description =
    trigger === 'limit_reached'
      ? `You used ${limit ?? 0} of ${limit ?? 0} daily ${featureName.toLowerCase()} uses. Upgrade to Pro for unlimited access.`
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[calc(100%-2rem)] md:max-w-lg">
        ...
        <div className="flex flex-col gap-3 pt-2">
          <Button className="w-full h-11 bg-primary text-primary-foreground" onClick={handleUpgrade}>
            Upgrade to Pro
          </Button>
