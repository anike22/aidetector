-- =====================================================================
-- FIX: team allocation fallback referenced wrong columns (is_active,
-- used_credits, team_owner_id). Actual columns: status/consumed_credits/
-- owner_id. Guarded FOR UPDATE on team rows.
-- =====================================================================
...
BEGIN
  ...
  -- Team allocation fallback (actual columns: status, consumed_credits, owner_id)
