...
**Endpoint:** `GET https://app-c18l1vf2nz7l-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod`
...
async function getEodData(symbol: string, params: EodParams = {}): Promise<EodResponse> {
  ...
  const response = await fetch(
    `https://app-c18l1vf2nz7l-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod?${query.toString()}`,
