...
**Endpoint:** `GET https://app-c18l1vf2nz7l-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-c18l1vf2nz7l-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
