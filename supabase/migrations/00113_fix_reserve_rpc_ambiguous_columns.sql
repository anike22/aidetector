-- =====================================================================
-- Fix 42702 (ambiguous column) in reserve_entitlement_and_credits:
-- RETURNS TABLE(...) OUT parameters (trial_checks_remaining etc.) shadow
-- unqualified column refs in UPDATE ... SET x = x - 1 RETURNING x.
-- Qualify all such references with table aliases.
-- =====================================================================
...
BEGIN
  ...
  IF p_user_id IS NULL THEN
    ...
    -- ATOMIC DEDUCTION at reserve time (alias-qualified to avoid 42702)
