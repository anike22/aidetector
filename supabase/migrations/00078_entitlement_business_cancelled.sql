-- Fix entitlement checks to honor Business plans and canceled-but-active subscriptions.

INSERT INTO public.feature_limits (feature_slug, plan, daily_limit, monthly_limit) VALUES
  ('ai_detector', 'business', NULL, NULL),
  ('seo_assistant', 'business', NULL, NULL),
  ('seo_content_studio', 'business', NULL, NULL),
  ('ai_humanizer', 'business', NULL, NULL),
  ('ai_image_detector', 'business', NULL, NULL),
  ('plagiarism_checker', 'business', NULL, NULL),
  ('hallucination_detector', 'business', NULL, NULL),
  ('citation_verifier', 'business', NULL, NULL)
...
BEGIN
  ...
  IF v_plan IN ('pro', 'business', 'enterprise') THEN
    SELECT (
