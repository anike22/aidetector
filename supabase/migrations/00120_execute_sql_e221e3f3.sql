...
BEGIN
  ...
  EXECUTE 'ALTER TABLE public.profiles DISABLE TRIGGER profiles_customer_profile';
  ...
  EXECUTE 'ALTER TABLE public.profiles ENABLE TRIGGER profiles_customer_profile';
