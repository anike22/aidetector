...
BEGIN
  ...
  EXECUTE 'ALTER TABLE public.profiles DISABLE TRIGGER trg_profiles_customer_profile';
  ...
  EXECUTE 'ALTER TABLE public.profiles ENABLE TRIGGER trg_profiles_customer_profile';
